  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          'text-foreground/80 rounded-md flex-1 font-semibold text-sm',
        ...
        day: cn(
          ...
          'h-10 w-full p-0 font-medium text-sm aria-selected:opacity-100 hover:bg-accent hover:text-accent-foreground'
        ),
